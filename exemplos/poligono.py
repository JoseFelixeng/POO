...
class Poligono(ABC):
    ...
    def distancia(pol1, pol2):
        ...
        """
        return math.sqrt((pol2.centro[0] - pol1.centro[0])**2 + (pol2.centro[1] - pol1.centro[1])**2)
    ...
    def lados_iguais(self):
        ...
        """
        for i in range(1, self.num_lados):
...
class PoligonoRegular(Poligono):
    ...
    def __init__(self, centro, lados):
        ...
        """
        Poligono.__init__(self, centro, lados)
    ...
    def area(self):
        ...
        s = self.lados[0]
        n = self.num_lados
        return (s*self.perimetro())/(4*math.tan(math.pi/n))
    ...
    def __repr__(self):
        ...
        str
            Representação do objeto em forma de str.
        """
        s = Poligono.__repr__(self)
        return f'Poligono regular de {self.num_lados} lados, lado igual a {self.lados[0]} {s}'
...
class Retangulo(Poligono):
    ...
    def __init__(self, centro, lados):
        ...
        """
        Poligono.__init__(self, centro, (lados[0], lados[0], lados[1], lados[1]))
    ...
    def __repr__(self):
        ...
        """
        s = Poligono.__repr__(self)
        return f'Retângulo com base {self.lados[0]} e altura {self.lados[1]} {s}'
...
class TrianguloEquilatero(PoligonoRegular):
    ...
    def __init__(self, centro, s):
        ...
        """
        PoligonoRegular.__init__(self, centro, (s, s, s))
    ...
    def __repr__(self):
        ...
        """
        s = Poligono.__repr__(self)
        return f'Triangulo equilatero com lado igual a {self.lados[0]} {s}'
...
class Quadrado(PoligonoRegular):
    ...
    def __init__(self, centro, s):
        ...
        """
        PoligonoRegular.__init__(self, centro, (s, s, s, s))
    ...
    def __repr__(self):
        ...
        """
        s = Poligono.__repr__(self)
        return f'Quadrado com lado igual a {self.lados[0]} {s}'
